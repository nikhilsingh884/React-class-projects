...
import {  getInventory, updateProduct } from '../Redux/InventorySlice';




function EditProductModal({ editOpen, editHandleClose, editValue }) {
    ...
    return (
        <div>
            <Dialog maxWidth="sm" fullWidth open={editOpen} >
                <div className="bg-light d-flex justify-content-between align-items-center pe-4">
                    <DialogTitle className='fs-2  fw-bold'>Edit product details</DialogTitle>
                    <CloseOutlinedIcon onClick={editHandleClose} />
                </div>
                <hr className='my-0' />
                        ...
                        () => {
                            return <Form>
                                ...
                                <button className='btn-primary btn w-100 mb-3' type='submit'>
                                    {
                                        addProductLoading ? "adding.." : "Update details"
                                    }
                                </button>
